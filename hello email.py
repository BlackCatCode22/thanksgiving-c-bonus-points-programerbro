...
# Usage
sender = "tonythecharger@gmail.com"
receiver = "tonythecharger@gmail,com",
app_password = "CamaroZl11le2018"  # Consider using a more secure method to store and retrieve this
